    ...
    <div>
      ...
      <main className=' bg-gradient-to-tl from-indigo-500 via-slate-900 to-black px-10 md:px-20 lg:px-40 max-w-screen'>
        <nav className="text-4xl md:text-5xl lg:text-5xl flex justify-center gap-10 py-3 flex-row md:flex flex-grow pt-10">
            <Link href="https://linkedin.com/in/esslam-ashour"><AiOutlineLinkedin className="text-white hover:text-indigo-600 transition ease-in" /></Link>
            <Link href="https://github.com/esslam-ashour"><AiOutlineGithub className="text-white hover:text-indigo-600 transition ease-in" /></Link>
            <Link href="mailto:esslamhosam@gmail.com"><AiOutlineMail className="text-white hover:text-indigo-600 transition ease-in" /></Link>
            <Link href="/resume.pdf"><CgFileDocument className="text-white hover:text-indigo-600 transition ease-in"/></Link>
        </nav>
          ...
          <div className="justify-end pl-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
            <div className="border-2 border-indigo-500 bg-opacity-25 flex flex-col bg-white text-indigo-500 px-10 py-10 mr-8 mt-4 mb-4 rounded-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-3">
                <Link href="#"><p className="border-2 border-white transition ease-in hover:bg-indigo-700 hover:translate-y-1 bg-indigo-500 text-white rounded-xl py-2 px-3 text-center">GoQuizCLI<br/><span className='text-sm text-gray-300'>A CLI quiz app</span></p></Link>
